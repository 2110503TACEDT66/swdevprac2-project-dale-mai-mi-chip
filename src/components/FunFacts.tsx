        ...
        <div className="flex flex-col w-[50%] ">
          <div className="flex flex-row gap-10 ">
            ...
            <div className="w-[100%] bg-white flex flex-col p-5 justify-center items-center h-[40%] rounded-lg ">
              ...
              <div className="text-center text-black font-bold"> Types of Massage </div>
            </div>
          </div>
          <div className="flex flex-col mt-10 ">
            <div className="flex flex-row gap-10">
              <div className="w-[100%] bg-white flex flex-row p-5 justify-around items-center rounded-lg ">
                ...
                <div className="text-center text-black font-bold"> Authentic Thai spa and massage in Phuket, Discover here </div>
              </div>
            </div>
          </div>
        </div>
