  ...
  return (
    <div className=" py-10  px-[20vh]">
      <div className="flex flex-col gap-5 text-center pt-[15vh] z-50">
        <div className="bg-black w-[40%] h-[25vh] absolute rounded-[5vh] z-0 right-[20vh] top-[756vh] text-center text-white flex flex-col pt-6">
          <div className="text-6xl font-extrabold mt-5 ">About US</div>
        </div>
        <div className="px-[15vh] bg-black  flex flex-col h-[28vh] bg-black text-white rounded-[6vh] items-start justify-center ">
          <div className="absolute text-4xl p-3 text-white bg-white w-[20vh] h-[20vh] left-[5vw] rounded-full" />
          <div className="text-5xl p-3 text-white z-50">
        ...
        <div className="px-[15vh] items-start justify-center bg-black  flex flex-col h-[28vh] bg-black text-white rounded-[6vh]">
          <div className="absolute text-4xl p-3 text-white bg-white w-[20vh] h-[20vh] left-[5vw] rounded-full" />
          <div className="text-5xl p-3 text-white">
