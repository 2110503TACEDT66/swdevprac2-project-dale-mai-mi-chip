export default function About() {
  return (
    <div className=" py-10  px-[20vh]">
      ...
      <div className="flex justify-center items-center text-black text-2xl font-bold text-5xl py-20 ">GitHub : <a href="https://github.com/2110503TACEDT66/swdevprac2-project-dale-mai-mi-chip" className="font-light text-xl underline">https://github.com/2110503TACEDT66/swdevprac2-project-dale-mai-mi-chip</a></div>
    </div>
  );
}
