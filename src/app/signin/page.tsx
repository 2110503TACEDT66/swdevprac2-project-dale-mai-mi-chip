  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-subPageStart to-subPageEnd">
      ...
      <div className="bg-black px-8 py-6 rounded-3xl shadow-md text-left mx-auto w-3/4 md:w-1/2 h-3/4">
        <h1 className="text-white text-3xl font-bold text-center mb-4">LOG - IN</h1>
        <form className="space-y-4">
          ...
          <div className="flex items-center justify-center">
            <button type="submit" className="inline-flex px-5 py-1 rounded-full bg-white hover:bg-grey text-black">Log In</button>
          </div>
        </form>
        <br></br>
        <p className="border-b border-white"></p>
        <p className="text-white text-xs text-center mt-4">Don't have an account? | <button type="submit" className="inline-flex px-2 py-1 rounded-full bg-white hover:bg-grey text-black">Register</button></p>
      </div>
    </div>
  );
}
